...
*   **Imagen:**
    ![Composición de Capas Base](./figures/04_capas_base_analisis.png)
...
*   **Imagen:**
    ![Mapa de Densidades](./figures/06_mapa_densidad_baja_media_alta.png)
...
*   **Imagen:**
    ![Zonas Rurales de Control](./figures/rural_reference_zones_map.png)
...
*   **Imagen:**
    ![Gradiente SUHI Diurna](./figures/real_day_suhi_zmm_full_gradient.png)
...
*   **Imagen:**
    ![Overview Hotspots Diurnos](./figures/real_day_hotspots_overview_map.png)
...
*   **Imagen:**
    ![Overview Top Hotspots](./figures/hotspots_top3_overview_map.png)
...
*   **Imágenes:**
    ```carousel
    ![Zoom Hotspot 1](./figures/hotspot_1_zoom_map.png)
    <!-- slide -->
    ![Zoom Hotspot 2](./figures/hotspot_2_zoom_map.png)
    <!-- slide -->
    ![Zoom Hotspot 3](./figures/hotspot_3_zoom_map.png)
    <!-- slide -->
    ![Zoom Hotspot 4 - Ternium](./figures/hotspot_ternium_zoom_map.png)
    ```
...
*   **Imagen:**
    ![Evolución Temporal LST](./figures/05_lst_average_temporal_evolution.png)
...
*   **Imagen:**
    ![SUHI Nocturna 30m](./figures/real_night_suhi_zmm_30m_nearest.png)
...
*   **Imagen:**
    ![SUHI Nocturna 1km](./figures/real_night_suhi_zmm_1km_native.png)
...
*   **Imagen:**
    ![Overview Hotspots Nocturnos](./figures/real_night_hotspots_overview_map.png)
