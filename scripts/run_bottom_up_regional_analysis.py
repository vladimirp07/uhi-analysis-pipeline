...
def main():
    ...
    print("\n>>> TOP 5 MUNICIPIOS CON MAYOR ASOCIACIÓN DE ENFRIAMIENTO LOCAL (green_pct) - Global:")
    ...
    # Asociación de la Vegetación según Densidad en Municipios
    print("\n>>> ANÁLISIS DE ASOCIACIÓN DE LA VEGETACIÓN SEGÚN DENSIDAD (green_pct):")
...
def generate_markdown_report(df_muni, df_ageb, base_dir):
    """Genera un archivo markdown detallando los hallazgos del análisis bottom-up"""
...
""")
        f.write(r"""## 5. Recomendaciones de Intervención Urbana y Política Pública
